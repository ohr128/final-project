...
function SideMenu(props) {
  ...
  return (
    <div className="w-1/7 font-notokr">
      ...
      <ul className="mb-4">
        {bigMenu.sub?.map((menu, idx)=>(
            <li key={idx}>
                <Link className={`px-5 py-4 block font-semibold border-y border-y-gray-300 text-lg ${ menu.subLink == from ? "bg-primary-500 text-white" : "hover:text-primary-500"}`} 
                    to={menu.subLink}>
                    {menu.subTitle}
                </Link>    
            </li>
