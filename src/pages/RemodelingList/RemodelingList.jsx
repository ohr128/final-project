                ...
                <AccordionItem
                  ...
                  content={
                    <div className="flex flex-col gap-3 p-2">
                      <p><span className="font-semibold">견적 대상:</span> {data.location}</p>
                      <p><span className="font-semibold">평수:</span> {data.size}</p>
                      <p><span className="font-semibold">가격:</span> {data.price}원</p>
                    </div>
                  }
