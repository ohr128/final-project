          ...
          <div className="flex flex-col w-full gap-2">
            <div>
              <input
                ...
                type="text"
              />
              <button className="bg-primary-500 w-28 h-10 text-white ml-1 rounded cursor-pointer">
                인증번호 전송
              </button>
            </div>
            ...
            <div className="flex justify-center gap-3 my-20">
              ...
              <button className="w-1/4 bg-primary-500 text-white rounded px-4 py-2 cursor-pointer">
                수정하기
              </button>
            </div>
          </div>
